            ...
            <div class="single-post nobottommargin">
              ...
              <div class="panel panel-default">
                  <div class="panel-heading">
                      <h3 class="panel-title"><?php e_('Posted by', 'Udemy') ?> <span><a href="#"><?php the_author(); ?></a></span></h3>
                  </div>
                  <div class="panel-body">
                      <div class="author-image">
                          <?php 
                          get_avatar($author_ID, 90, '', false, array(
                            'class' => 'img-circle'
                          )); 
                          ?>
                      </div>
              ...
              <h4><?php e_('Related Posts:', 'Udemy') ?></h4>
